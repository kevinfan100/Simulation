...
if ENABLE_PLOT
    ...
    if strcmpi(signal_type_name, 'sine')
        ...
        ylabel('Vm (V)', 'FontSize', 11);
        title('Full System Response', 'FontSize', 12, 'FontWeight', 'normal');
        legend({'P1', 'P2', 'P3', 'P4', 'P5', 'P6'}, ...
        ...
        grid on;
        xlabel('Time (s)', 'FontSize', 11);
        ylabel('Error (V)', 'FontSize', 11);
        title('Tracking Error', 'FontSize', 12, 'FontWeight', 'normal');
        legend({'P1', 'P2', 'P3', 'P4', 'P5', 'P6'}, ...
               'Location', 'best', 'FontSize', 9);
        ...
        title('Control Input', 'FontSize', 12, 'FontWeight', 'normal');
        legend({'P1', 'P2', 'P3', 'P4', 'P5', 'P6'}, ...
               'Location', 'best', 'FontSize', 9);
