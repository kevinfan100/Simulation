function params = r_controller_calc_params(fB_c, fB_e)
    ...
    % ========================================
    params.alpha_vf = 1 / ((1 - lambda_c) * (1 + params.b));
    params.c0_b = params.b;                                      % c0 = b
    params.c1_one_S_b_M_lambda_c = 1 - params.b * lambda_c;      % c1 = 1 - b·λc
    params.c2_neg_lambda_c = -lambda_c;                          % c2 = -λc

    % Recursive filter: delta_vf[k] = vf[k] - (1-bc)*vf[k-1] - bc*vf[k-2]
    ...
    % Define all bus elements (22 fields)
